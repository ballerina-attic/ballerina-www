...
+'<li class="toctree-l1" id="openli"><a href="https://staging-central.ballerina.io/">Central</a></li>'
...
+'<input type="text" name="q" id="mkdocs-search-query" placeholder="Search" class="wy-form" autocomplete="off" />'
+'</form>'
+'</div></div>'
+'</li>'
+'</ul>'
