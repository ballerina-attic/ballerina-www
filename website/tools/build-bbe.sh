...
git --git-dir=ballerina-lang/.git --work-tree=ballerina-lang/ checkout v0.990.3
...
git --git-dir=docker/.git --work-tree=docker/ checkout v0.990.3
...
git --git-dir=kubernetes/.git --work-tree=kubernetes/ checkout v0.990.3
mkdir -p target/dependencies/ballerina-examples/examples
...
git --git-dir=jdbc/.git --work-tree=jdbc/ checkout v0.990.3
mkdir -p target/dependencies/ballerina-examples/examples
...
git --git-dir=awslambda/.git --work-tree=awslambda/ checkout v0.990.3
mkdir -p target/dependencies/ballerina-examples/examples
