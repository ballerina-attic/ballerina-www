...
I am a programmer *
  ...
  <li>
<textarea type="text" maxlength="550" value="" name="issues" placeholder="I use the following languages" title="List of GitHub issues you filed" class="cTextfieldstyle cTextarea contact_issues" style="height: 100px;" aria-invalid="false"></textarea>
  </li>
