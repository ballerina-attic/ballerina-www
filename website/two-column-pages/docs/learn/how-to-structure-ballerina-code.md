...
The folders `tests/`, and `resources/` are reserved folder names within the module. The `tests/` folder contains module 
...
/
    project-name/
        .gitignore
        Balleirna.lock             # Generated during build, used to rebuild identical binary
...
BALO cache is responsible of keeping BALOs of dependent modules. There is a BALO cache inside the Ballerina 
...
A repository is a collection of compiled Ballerina modules. A repository helps organize modules used by multiple 
