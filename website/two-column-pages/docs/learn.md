...
The [Language Specification](/res/language-specification.pdf) is a set of documents that explain more about the inner workings of the Ballerina language itself.
